    ...
    return (
        <div className="app-container">
            <div className="instructions">
                ...
                <ol>
                    <li>Clearly explain in a conversational manner what you want.<br/>
                        <em>Example: Can you help me with the exercise: [insert full exercise]? Here is what I have so far: [insert code].</em>
                    </li>
                    ...
                    <li>If you get an error in your code, feel free to paste your code into the chatbot and ask it to help you find the error, then paste the error message you are receiving.<br/>
                        <em>Example: In this code [insert code here], I get this error: [insert error message], can you help me identify and fix the error?</em>
                    </li>
